...
setwd("C:/Users/anna.zoechner/OneDrive - Bundesforschungszentrum fuer Wald/Dokumente/GitHub/CrataegusAnalysis/Analysis_within_species/Rhipidophylla")
...
# Creating subset with data of Rhipidophylla
df_sub <- subset(df, samp_target == "4")
