...
boxplot(df_sub_L[,3:9], main="Laevigata",ylim = c(0,14),las=2)
boxplot(df_sub_R[,3:9], main="Rhipidophylla",ylim = c(0,14),las=2)
boxplot(df_sub_M[,3:9], main="Monogyna",ylim = c(0,14),las=2)
